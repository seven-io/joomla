...
/** @var \Seven\Component\Seven\Administrator\View\Voices\HtmlView $this */

$listOrder = $this->escape($this->state->get('list.ordering'));
$listDirn = $this->escape($this->state->get('list.direction'));
?>
<form action="<?php echo Route::_('index.php?option=com_seven&view=voices'); ?>" method="post" name="adminForm" id="adminForm">
    <div class="row">
        <div class="col-md-12">
            <div id="j-main-container" class="j-main-container">
                ...
                <?php else : ?>
                    <table class="table" id="voiceList">
                        <caption class="visually-hidden">
                            <?php echo Text::_('COM_SEVEN_VOICES_TABLE_CAPTION'); ?>
                        </caption>
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <?php foreach ($this->items as $i => $item) : ?>
                                <tr class="row<?php echo $i % 2; ?>">
                                    ...
                                    <td>
                                        <a href="<?php echo Route::_('index.php?option=com_seven&task=voice.edit&id=' . $item->id); ?>">
                                    ...
                                    <td class="text-center">
                                        ...
                                        ?>
                                        <span class="badge <?php echo $badgeClass; ?>" title="<?php echo $this->escape(SevenHelper::getVoiceStatusDescription($statusCode)); ?>">
                                            <?php echo $statusCode; ?>
                                        </span>
                                    </td>
                                    <td class="d-none d-md-table-cell">
